<div id="container">
    ...
    <h1 class="post-list-title round"><?php printf( __( 'Você está em <strong>%s</strong>', $this->_name ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h1>
...
?>
				<div id="post" class="transparencia clearfix">
					...
					<div class="entry-content">
                        ...
                        <?php $this->includeThemeShared('SearchForm.php'); ?>
					</div><!-- .entry-content -->
